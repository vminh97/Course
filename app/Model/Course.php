...
class Course extends Model
{
    ...
    protected $fillable = ['goods_code','slug_url','name_product','teacher_id','introduction_product','content_product','title_procduct','category_id','certificatebill_id',
    ...
    'date_promotion_start','date_promotion_end'];
}
