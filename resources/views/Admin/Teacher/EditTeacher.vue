                                ...
                                <b-row>
                                    <b-col md="12" lg="12">
                                        <b-row>
                                            ...
                                            <b-col md="4"><input type="text" v-model="teacher.customer_name"></b-col>
...
export default {
    ...
    methods: {
      async editTeacher()
            {
                try {
                    ...
                    const response = await axios.get('/api/teacher/edit/'+index);
      ...
      {
          const index= this.$route.params.id;
          let uri = `http://127.0.0.1:8000/api/teacher/update/`+index;
